...
export default function BrandsAndNewsletter() {
  return (
    <div className="py-10 container mx-auto  text-center">
      ...
      {/* Newsletter CTA */}
      <div className="md:bg-black text-white py-8 px-6 mt-12 rounded-full flex flex-col md:flex-row items-center justify-between gap-6  mx-auto">
        <h3 className="text-xl md:text-2xl font-semibold">
          Join Our Newsletter
        </h3>
        <div className="flex items-center bg-gray-400  md:bg-white rounded-full px-4 py-2 w-full md:w-auto">
          <input
            type="email"
